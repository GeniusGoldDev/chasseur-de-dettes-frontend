    ...
    <div class="px-4 lg:px-[150px] container mx-auto py-4 justify-between items-center">
      <div class="w-full flex flex-col lg:flex-row justify-between">
        <div class="mb-4 lg:mb-0">
          ...
          <p class="text-[#0A0908] font-family[Metropolis] text-[12px] lg:text-[14px] font-medium leading-[16px] lg:leading-[20.3px] text-left opacity-56">
            Découvrez les dernières inscriptions et ne manquez pas les nouvelles opportunités qui s’offrent à vous !
          </p>
        </div>
