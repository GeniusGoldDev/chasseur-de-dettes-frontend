<template>
    <header class="bg-[#FAF6FE] fixed  w-full z-[200] h-[80px] pt-[20px] px-[20px] lg:py-0 lg:px-0">
      <nav class="container mx-auto flex justify-between items-center ">
        <!-- Logo -->
        <div class="logo text-2xl font-bold">
          <nuxt-link to="/">
            <img src="./../assets/Logo.svg" alt="Brand Logo" class="h-8 w-auto" />
          </nuxt-link>
        </div>
        ...
        <div 
          :class="[
            ...
            'px-[50px] absolute top-20 right-0 w-[80%] bg-white shadow-lg lg:shadow-none lg:bg-transparent lg:w-auto'
          ]"
        >
          <ul class="flex flex-col lg:flex-row lg:space-x-10 text-gray-700">
            <li class="mt-3 lg:mt-0">
              <nuxt-link 
                to="/" 
                class="font-medium text-[14px] leading-[20.3px] text-[#585654] hover:font-bold"
